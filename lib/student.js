    ...
    deregisterClass: function(universityClass) {
      if (universityClass instanceof UniversityClass) {
        if (this.classes.has(universityClass)) {
          ...
          throw new Errors.NotFoundError("Student already not registered for this class");
        }
      } else {
        throw new Errors.TypeError("Only instances of University Class may be deregistered");
      }
    },
